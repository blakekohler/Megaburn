...
public partial class Admin : System.Web.UI.Page
{
    ...
    private bool UploadFile(bool isUpdate)
    {
        ...
        if (uploader.PostedFile.FileName == "" && isUpdate)
        {
            ...
            SqlDataSource2.UpdateParameters["Prod_Image"].DefaultValue = origfilename.Value;
        ...
        else
        {
            ...
            try
            {
                ...
                SqlDataSource2.UpdateParameters["Prod_Image"].DefaultValue = serverFileName;
                SqlDataSource2.InsertParameters["Prod_Image"].DefaultValue = serverFileName;
                return true;
